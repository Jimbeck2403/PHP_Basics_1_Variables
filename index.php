    ...
    <div class="container my-container">
        <div class="jumbotron">
            ...
            <div>
                ...
                <div class="my-5">
                    <p>
                        ...
                        En PHP, le typage des variables est dynamique, cela veut dire que l'on n'a pas besoin de présiser le type, PHP s'en chargera lui-même grâce à la synthaxe : <br>
                    </p>
                    <p>
            ...
            <div class="text-center">
                <a class="btn btn-primary" href="homepage.php" role="button">Commencer <i class="far fa-arrow-alt-circle-right"></i></a>
            </div>
        </div>
    </div>
